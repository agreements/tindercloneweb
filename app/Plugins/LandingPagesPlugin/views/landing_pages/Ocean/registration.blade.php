...
/*             background: url("@plugin_asset('LandingPagesPlugin/images/heart_small.gif')")  50% 50% no-repeat rgb(249,249,249); */
    ...
    <body style="background:url('@if($website_backgroundimage) {{{asset("uploads/backgroundimage/{$website_backgroundimage}")}}} @else @plugin_asset('LandingPagesPlugin/Ocean/images/bg.png') @endif');background-size:cover;">
    ...
    <div class="col-md-12 col_bg_img col_main-height bg_size">
        <div class="row">
            <div class="@if($only_social_logins == 'true') col-md-12 makeitcenter @else col-md-6 @endif col-xs-12 col_main-text-margin text-center">
                ...
                <p class="text_white display_inline social_p_margin opacity_7">{{{trans_choice('LandingPagesPlugin.first_screen_main_heading_sub',2)}}}</p><br>

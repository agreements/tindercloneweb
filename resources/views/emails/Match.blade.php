 ...
 <table border="1" cellpadding="0" cellspacing="0" width="100%;">
  <tr>
   <td>
       ...
       <tr>
           <td style="background-color: #FFFFFF;padding:0px 0px 10px 24px;border-top: 2px solid #FF4E79;">
            <div style="display:inline-block;">
                 ...
                 <p style="font-size: 18px;margin-top: 24px;margin-left:6px;opacity:0.8;font-family: 'Roboto';">{{{trans('email.match_found')}}}</p>
    ...
    -webkit-margin-end: 0px;position:relative;top:-12px;margin-bottom:0px;"><span>{{{$user2->name}}}</span>, <span>{{{$user2->age()}}}</span></h4>
  ...
  font-size: 16px;
  color: black;
  opacity: 0.87;margin: 0 0 10px;">You and {{{$user2->name}}} {{{trans('email.like_each_other')}}}</p>
